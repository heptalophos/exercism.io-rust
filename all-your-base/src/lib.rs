...
///
/// You are allowed to change the function signature 
/// as long as all test still pass.
///
/// Example:
/// Input
///   number: &[4, 2]
...
///    However, your function must be able to process input 
///    with leading 0 digits.
///
